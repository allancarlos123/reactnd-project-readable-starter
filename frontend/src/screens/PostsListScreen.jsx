...
export default class PostsListScreen extends Component {
  state = {
    ...
    return (
      <Grid columns={1} container>
        ...
        <Grid.Column computer={12}>
          <h3>filtered category by: {this.props.match.params.category}</h3>
          <PostsList {...this.props} sortBy={activeSortBy}/>
        </Grid.Column>
      </Grid>
    );
  }
